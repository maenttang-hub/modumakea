...
with seed_rows as (
  select *
  from jsonb_to_recordset($components_seed$[
  {
    "id": "tpl_ultrasonic",
    "name": "초음파 센서",
    "category": "SENSOR",
    ...
    "library_source": "core",
    "default_value": null,
    "datasheet_status": "needs-vendor-pin",
  ...
  },
  {
    ...
    "design": {
      ...
      "datasheetSources": [
        {
          "label": "Aosong DHT11 Product Page",
          "url": "https://www.aosong.com/en/Products/info.aspx?itemid=2257&lcid=139"
        },
        {
          "label": "Aosong Download Center",
          "url": "https://www.aosong.com/en/DownloadCenter/index.aspx?page=2"
        }
      ],
      "preferredBoardPins": {
        "uno": {
    ...
    "library_source": "core",
    "default_value": null,
    "datasheet_status": "official-partial",
    "popularity_rank": null,
    "package_version": null
  },
  {
    ...
    "design": {
      ...
      "datasheetSources": [
        {
          "label": "Aosong AM2302 Product Page",
          "url": "https://www.aosong.com/en/Products/info.aspx?itemid=2294&lcid=139"
        },
        {
          "label": "Aosong Download Center",
          "url": "https://www.aosong.com/en/DownloadCenter/index.aspx?page=2"
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "Module:soil_moisture",
      "packageType": "THT",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "design": {
      ...
      "datasheetSources": [
        {
          "label": "Winsen MQ-2 Product Page",
          "url": "https://www.winsen-sensor.com/product/mq-2.html"
        },
        {
          "label": "Winsen MQ-2 Datasheet",
          "url": "https://www.winsen-sensor.com/d/files/manual/mq-2.pdf"
        }
      ],
      "preferredBoardPins": {
        "uno": {
    ...
    "library_source": "core",
    "default_value": null,
    "datasheet_status": "official-complete",
    "popularity_rank": null,
    "package_version": null
  },
  {
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "LED_THT:LED_RGB_D5.0mm",
      "packageType": "THT",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "Relay_THT:Relay_SPDT_Songle_SRD",
      "packageType": "THT",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "Display:OLED_0.96_I2C",
      "packageType": "MODULE",
      "manufacturable": true
    },
    "dependencies": null,
    ...
    "library_source": "core",
    "default_value": null,
    "datasheet_status": "generic-module",
    "popularity_rank": null,
    "package_version": null
  },
  {
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "Inductor_THT:L_Axial_L9.0mm_D3.5mm_P12.00mm_Horizontal",
      "packageType": "THT",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "Module:Logic_Level_Shifter_4CH",
      "packageType": "MODULE",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "pcb_model": {
      "footprint": "Module:ADS1115_Breakout",
      "packageType": "MODULE",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "schematic_model": {
      "symbol": "op_amp_buffer",
      "referencePrefix": "U"
    },
    "pcb_model": {
      "footprint": "Module:op_amp_buffer",
      "packageType": "THT",
      "manufacturable": true
    },
    "dependencies": null,
  ...
  },
  {
    ...
    "name": "기압 센서 BMP280",
    "category": "SENSOR",
    "description": "BMP280: 공식 데이터시트가 확인된 Bosch 디지털 기압 센서",
    "icon": "Thermometer",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "환경 센서 BME280",
    "category": "SENSOR",
    "description": "BME280: 공식 데이터시트가 확인된 Bosch 온도/습도/기압 센서",
    "icon": "Thermometer",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "환경 센서 BME680",
    "category": "SENSOR",
    "description": "BME680: 공식 데이터시트가 확인된 Bosch 공기질/환경 센서",
    "icon": "Wind",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "온도 센서 DS18B20",
    "category": "SENSOR",
    "description": "DS18B20: 공식 데이터시트가 확인된 1-Wire 디지털 온도 센서",
    "icon": "Thermometer",
    "compatible_voltage": "BOTH",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "온도 센서 LM35",
    "category": "SENSOR",
    "description": "LM35: 공식 데이터시트가 확인된 TI 아날로그 온도 센서",
    "icon": "Thermometer",
    "compatible_voltage": "5V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "온습도 센서 SHT31",
    "category": "SENSOR",
    "description": "SHT31: 공식 데이터시트가 확인된 Sensirion 온습도 센서",
    "icon": "Droplets",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "ToF 센서 VL53L0X",
    "category": "SENSOR",
    "description": "VL53L0X: 공식 데이터시트가 확인된 ST 거리 측정 센서",
    "icon": "Radar",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "ToF 센서 VL53L1X",
    "category": "SENSOR",
    "description": "VL53L1X: 공식 데이터시트가 확인된 ST 장거리 ToF 센서",
    "icon": "Radar",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "자세 센서 BNO055",
    "category": "SENSOR",
    "description": "BNO055: 공식 데이터시트가 확인된 Bosch 9축 자세 센서",
    "icon": "Radar",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "전류 센서 INA219",
    "category": "SENSOR",
    "description": "INA219: 공식 데이터시트가 확인된 TI 전류/전력 모니터 센서",
    "icon": "Zap",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
  ...
  },
  {
    ...
    "name": "맥박 센서 MAX30102",
    "category": "SENSOR",
    "description": "MAX30102: 공식 데이터시트가 확인된 심박/산소포화도 센서",
    "icon": "Mic",
    "compatible_voltage": "3.3V",
    "required_pins": [
      {
...
insert into public.components (id, name, category, description, icon, compatible_voltage, required_pins, library_includes, simulation_model, schematic_model, pcb_model, dependencies, ai_hints, design, code, library_source, default_value, datasheet_status, popularity_rank, package_version)
select id, name, category, description, icon, compatible_voltage, required_pins, library_includes, simulation_model, schematic_model, pcb_model, dependencies, ai_hints, design, code, library_source, default_value, datasheet_status, popularity_rank, package_version
from seed_rows
on conflict (id) do update set
  ...
  icon = excluded.icon,
  compatible_voltage = excluded.compatible_voltage,
  required_pins = excluded.required_pins,
  library_includes = excluded.library_includes,
  simulation_model = excluded.simulation_model,
  schematic_model = excluded.schematic_model,
  pcb_model = excluded.pcb_model,
  ...
  datasheet_status = excluded.datasheet_status,
